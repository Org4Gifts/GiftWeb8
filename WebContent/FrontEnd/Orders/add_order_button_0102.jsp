...
/*			
			alert("m2.modal-123");
			//$('input[name="text1"]').val("1");
			var v=document.getElementById("manTextBox").value;
　			alert(v);
　			document.getElementById("manTextBox").value = "123";
　			var v1=document.getElementById("manTextBox").value;
　			alert(v1);
　			alert("title_opt = " + $('select[name="title_opt"]').val());
　			document.getElementById("text1").value = "6";
　			alert("ttt");
　			var v2=document.getElementById("text1").value;
　			alert(v2);　			
　			$('input[name="text1"]').val($('select[name="title_opt"]').val());
*/		
			$('#secondmodal').modal();
		});
		...
		$('#closeBtn').on("click", function() {
			//alert("88888");
			//var v=document.getElementById("gift_opt").value;
			//alert("889");
			//alert(v);
			//alert("gift_opt = " + $('select[name="gift_opt"]').val());		
			//$('input[name="giftTextBox"]').val($('select[name="gift_opt"]').val());
			//$('input[name="giftTextBox"]').val($('input[name="manTextBox1"]').val());
			$('input[name="giftTextBox"]').val($('select[name="gift_opt"]').val());			
		});
	...
	$("#closeBtn").click(function(){
		...
		alert(v);
		alert("gift_opt = " + $('select[name="gift_opt"]').val());		
		//var t = $('select[name="gift_opt"]').val()；
		//$("#giftTextBox").attr("value", t);
　		//$('input[name="giftTextBox"]').val($('select[name="gift_opt"]').val());
　		　		$('input[name="giftTextBox"]').val($('select[name="gift_opt"]').val());
		//$("#giftTextBox").attr("value", t);
		});
...
<div class="right" id="mainFrame">
	<div class="right_cont">
		...
		<div id="secondmodal" class="modal container fade" tabindex="-1"
					...
					<tbody>
						...
						<tr>
							...
							<td align="left"><select name="gift_opt">
									<%
										String title = request.getParameter("text1") == null ? "N/A" : request.getParameter("text1");
			...
			<div class="modal-footer" style="text-align: center;">
				<button type="button" data-dismiss="modal" class="btn btn-default" id="closeBtn">關閉</button>
			</div>
		</div>
