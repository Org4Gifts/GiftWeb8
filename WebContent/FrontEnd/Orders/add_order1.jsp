...
<body>
        ...
        <div class="right" id="mainFrame">
            ...
            <div class="right_cont">
                <ul class="breadcrumb">当前位置：
                    ...
                    <a href="#">业务处理</a> <span class="divider">/</span> 电脑开票
                </ul>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <input name="manTextBox" type="text" id="manTextBox" class="span1-1" />
                                    </td>
                                    <td align="right">电话:</td>
                                    <td align="left" colspan="3">
                                        <input name="phoneTextBox" type="text" id="phoneTextBox" class="span1-1" />
                                    </td>
                                </tr>
                                <tr>
                ...
                <table class="margin-bottom-20 table  no-border">
                    <tr>
                        <td class="text-center">
                            <input type="button" value="打印" class="btn btn-info" style="width:80px;" />
                        </td>
                    </tr>
                </table>
    ...
    <!-- 底部 -->
    <div id="footer">版权所有：晶科客流 &copy; 2015&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://h2design.taobao.com/" target="_blank">氢设计</a></div>
