...
<script type="text/javascript">
	$(function() {
		...
		$('#m2').on("click", function() {
			//$('input[name="manTextBox1"]').val("333");1			
			alert("888");
			var tmp = $('select[name="title_opt"]').val();
			alert("tmp = " + tmp);			
			var tmp1 = "#secondmodal" + tmp;
			alert("tmp1 = " + tmp1);
			//$('#secondmodal').modal();
			$(tmp1).modal();
		});
		...
		$('#closeBtn1').on("click", function() {
			//$('input[name="giftTextBox"]').val($('select[name="gift_opt1"]').val());			
			var tmp = $('select[name="gift_opt1"]').val();
			$('input[name="giftTextBox"]').val(tmp);
		});
		
		$('#closeBtn2').on("click", function() {
			//$('input[name="giftTextBox"]').val($('select[name="gift_opt2"]').val());			
			var tmp = $('select[name="gift_opt2"]').val();
			$('input[name="giftTextBox"]').val(tmp);
		});
...
<div class="right" id="mainFrame">
	<div class="right_cont">
		...
		<div id="secondmodal1" class="modal container fade" tabindex="-1"
			style="display: none;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">×</button>
			...
			<div class="modal-footer" style="text-align: center;">
				<button type="button" data-dismiss="modal" class="btn btn-default"
					id="closeBtn1">關閉</button>
			</div>
		</div>
		
		<div id="secondmodal2" class="modal container fade" tabindex="-1"
			style="display: none;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">×</button>
