 ...
 -->
		...
		<div class="title_right">
			<span class="pull-right margin-bottom-5"> <a
				class="btn btn-info btn-small" id="m1"
				href="#modal-container-9735581" role="button"><i
...
<!--
 ...
 -->
							<span class="pull-right margin-bottom-5"> <a
								class="btn btn-info btn-small" id="m2"
								href="#modal-container-9735582" role="button">
								<i class="icon-plus icon-white"></i>禮品清單</a></span>
						</tr>
					</tbody>
				</table>
			</div>
